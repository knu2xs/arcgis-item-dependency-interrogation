...
<!--start-->
Using the ArcGIS Python API to interrogate ArcGIS Item dependencies.
...
3 - Start Building - If you are more into Python, a good place to start is `jupyter lab` from the root of the project, and 
  ...
  more your schtick, open the project `./arcgis/arcgis-item-dependency-interrogation.aprx`.
<!--end-->
