...
if importlib.util.find_spec("arcgis_dependency") is None:
    src_dir = find_pkg_source("arcgis_dependency")
...
class Toolbox:
    def __init__(self):
        ...
        self.label = "arcgis-item-dependency-interrogation"
        self.alias = "arcgis_dependency"
...
class ExampleTool:
    def __init__(self):
        ...
        # configure logging
        logger_name = f"arcgis_dependency.Toolbox.{self.__class__.__name__}"
