...
- [ ] T010 Define CRS validation and reprojection approach for spatial workflows (if applicable)
- [ ] T011 Define SQL externalization and parameterization approach (if applicable)
- [ ] T012 Confirm data input/output locations honor raw/interim/processed constraints
...
- [ ] TXXX Verify constitution compliance (config/secrets, CRS, logging, tests, SQL/data handling)
